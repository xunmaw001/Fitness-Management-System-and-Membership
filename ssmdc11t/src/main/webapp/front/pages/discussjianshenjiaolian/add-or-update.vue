	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussjianshenjiaolian`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																				...
																																																																				if(this.ruleForm.id){
					await this.$api.update(`discussjianshenjiaolian`, this.ruleForm);
				}else{
					await this.$api.add(`discussjianshenjiaolian`, this.ruleForm);
				}
